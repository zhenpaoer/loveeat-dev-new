 ...
 **/
@ToString
public enum ProductMenuDetailCode implements ResultCode {
	PRODUCTMENU_CREATE_FALSE(false,1001,"添加商品菜单失败！"),
	PRODUCTMENU_UPDATE_ERROR(false,1002,"商品菜单更新失败，请重试！"),
	PRODUCTMENU_DARACHECK_ERROR(false,1003,"商品菜单数据校验失败，请重试！"),
	PRODUCTMENU_SAVE_ERROR(false,1004,"商品菜单保存失败，请重试！"),
	PRODUCTMENU_NAME_EXIT(false,1013,"商品菜单标题已存在，请重试！");
/*	PRODUCT_CHECK_ID_FALSE(false,1002,"id校验失败，请重试！"),
	...
	String message;
	private ProductMenuDetailCode(boolean success, int code, String message){
		this.success = success;
		this.code = code;
		this.message = message;
	}
	private static final ImmutableMap<Integer, ProductMenuDetailCode> CACHE;

	static {
		final ImmutableMap.Builder<Integer, ProductMenuDetailCode> builder = ImmutableMap.builder();
		for (ProductMenuDetailCode commonCode : values()) {
