...
public class Jcode2SessionUtil {
    ...
    public static String GET_USERINFO = "https://api.weixin.qq.com/sns/userinfo";
    public static String SEND_TEMPLATE_MESSAGE = "https://api.weixin.qq.com/cgi-bin/message/wxopen/template/send";
    ...
    public static String jscode2session(String appid,String secret,String code,String grantType)throws Exception{
        ...
        HttpPost httpPost = new HttpPost(JS_CODE_2_SESSION);
...
//        params.put("secret",secret);
        return HttpUtil.sendGet(GET_ACCESS_TOKEN+"?grant_type=client_credential&appid=" + appid + "&secret=" + secret);
    }
...
//        params.put("appid",appid);
//        params.put("secret",secret);
        String url = GET_USERINFO+"?openid="+openid+"&access_token=" + accessToken;
    ...
    public static String sendTemplateMessage(String access_token,String touser,String template_id,String page,String form_id,Object data,String emphasis_keyword){
        ...
        //发送请求
        return HttpUtil.sendPost(SEND_TEMPLATE_MESSAGE + "?access_token=" + access_token,params.toString());
    }
